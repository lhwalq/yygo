...
//        findViewById(R.id.iv_left).setBackground(IconicFontUtil.createIconicFontDrawableColor(BaseApplication.getInstance(), drawableId, colorId));
...
//        findViewById(R.id.tv_right_icon).setBackground(IconicFontUtil.createIconicFontDrawableColor(BaseApplication.getInstance(), drawableId, colorId));
